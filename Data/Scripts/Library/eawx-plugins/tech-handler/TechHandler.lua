...
function TechHandler:new(galactic_conquest, human_player, planets)
	...
	self.PentastarDestroyersResearch = GenericResearch(self.galactic_conquest,
		"PENTASTAR_DESTROYERS_RESEARCH",
		"Dummy_Pentastar_Destroyers",
		{"Pentastar"},
	    {"Imperial_I_Star_Destroyer_PA", "Mandator_III_Dreadnought_PA", "Praetor_Carrier_Battlecruiser_PA", "Procursator_Star_Destroyer_PA", "Secutor_Star_Destroyer_PA", "Venator_Star_Destroyer_PA", "Imperial_Cargo_Ship"},
		{"Imperial_I_Star_Destroyer", "Mandator_III_Dreadnought", "Praetor_Carrier_Battlecruiser", "Procursator_Star_Destroyer", "Secutor_Star_Destroyer", "Venator_Star_Destroyer", "Proteus_Cargo_Ship"}
		)
		
	self.RaptorResearch = GenericResearch(self.galactic_conquest,
		"RAPTOR_RESEARCH",
		"Dummy_Research_Raptor", {"Zsinj_Empire"},
	    {"Raptor_Trooper_Company", "Zsinj_74Z_Bike_Company", "Raptor_Commando_Company"},
        {"Imperial_Army_74Z_Bike_Company", "Imperial_Army_Guard_Company"})
end
