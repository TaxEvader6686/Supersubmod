...
return {
		...
		["ADELHARD"] = {
			FriendlyName = "Adelhard Coalition",
			Planets = {"ANOAT", "BESPIN", "HOTH",},
			LeaderTable= {"ADELHARD_SCEPTER"},
			LeaderEndingNames = {"Emperor Adelhard"},
			HeroList = {"Adelhard_Scepter", "Bragh_Team", "Reyna_Oskure_Team"},
			UnlockList = {
				-- Space
		    	"Gozanti_Cruiser_Group", "Raider_I_Corvette", "Raider_II_Corvette", "Arquitens_Refit", "Galleon", "Quasar",
				"Imperial_DHC", "Gladiator_I", "Immobilizer_Twin_Well", "Victory_II_Star_Destroyer",
				"Imperial_I_Star_Destroyer", "Imperial_II_Star_Destroyer", "Interdictor_Star_Destroyer",
				"Altor_Replenishment_Ship", "Communications_Battlecruiser", "Bellator_Star_Dreadnought", "Executor_Star_Dreadnought",
				-- Ground
				"Imperial_Army_Trooper_Company", "Anoat_Purge_Trooper_Company", "Imperial_74Z_Bike_Company", "Imperial_Jumptrooper_Company",
				"Imperial_AT_PT_Company", "RTT_Company", "Storm_Cloud_Car_Company", "AT_ST_Company",
				"AT_AA_Walker_Company", "2M_Repulsor_Tank_Company", "SPMAG_Walker_Company", "Imperial_Dropship_Transport_Company",
				"Tracked_Mobile_Base_Company", "B5_Juggernaut_Company", "Imperial_AT_AT_Walker_Company",
			},
			FactionOverride = "Rebel",
			FactionOverride2 = "Empire",
			IntroText = "TEXT_CONQUEST_PROTEUS_ADELHARD",
			IntroHolo = "Grunger_Loop",
		},
}
